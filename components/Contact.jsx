        ...
        <section className="">
            <div className="py-8 lg:pt-16 mx-auto max-w-screen-md">
                ...
                >
                    ...
                    <button type="submit" className="w-full justify-center gap-x-4 text-gray-900 hover:bg-slate-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:border-gray-700 dark:text-white dark:hover:bg-slate-700 me-2 mb-2">
